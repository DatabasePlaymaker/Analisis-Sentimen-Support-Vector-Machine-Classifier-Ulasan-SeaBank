# -*- coding: utf-8 -*-
"""Analisis Sentimen - [SVM] - Ulasan SeaBank - 2Label.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1yJj7sf7CClemsAdljKb9_-dxtflv9h7s
...
df = pd.read_csv("/content/drive/MyDrive/Dataset Ulasan Google Play/scrapped_data_SeaBank_1.csv")
df.head()
...
# df['steamming'].to_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_steamming_SeaBank_1.csv', index = False)

df_steamming = pd.read_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_steamming_SeaBank_1.csv', encoding = 'latin1')
df_steamming
...
# df_values.to_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_terjemahan_SeaBank_1.csv')

# Load Dataset Hasil Translate

df_values = pd.read_csv('/content/drive/MyDrive/Dataset Ulasan Google Play/hasil_terjemahan_SeaBank_1.csv', index_col=0)
df_values
...
show_bar_chart(labels, counts, "Distribusi Sentimen Ulasan Aplikasi SeaBank")
...
show_pie_chart(labels, counts, "Distribusi Sentimen Ulasan Aplikasi SeaBank")
